...
`SablierV2LockupDynamic`. Specifically, their [`core-1.0.0`](/contracts/limit/deployments). To provide a simple visual
...
| chainId    | Number  | Defaults to the connected chain                                                                               | `1`, `10`, `42161` or any other supported [chain](/contracts/limit/deployments)                   |
...
| c         | Number       | The chain of the streams in the search result. This parameter is required. | `1`, `10`, `42161` or any other supported [chain](/contracts/limit/deployments) |
