...
These emissions will be significantly expanded to bootstrap protocol adoption, and the revenue generated will help increase the capacity of operations (see [Protocol Revenue](/token/protocol-revenue)). More details on how `oFIN` works can be found on the [oFIN](/token/why-ofin) page.

##### Season Rewards Breakdown

*Biweekly Poolshark governance participants decide on emissions policy. The emission period of ~8 years was chosen to balance the need for incentivized rewards to early adopters while not distributing all FIN too early, which is required for long-term sustainability.*
